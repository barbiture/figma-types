 ...
 */
public enum RegularPolygonNodeType {
    ...
    @JsonCreator
    public static RegularPolygonNodeType forValue(String value) throws IOException {
        ...
        throw new IOException("Cannot deserialize RegularPolygonNodeType");
    }
}
