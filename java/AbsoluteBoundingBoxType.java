 ...
 */
public enum AbsoluteBoundingBoxType {
    ...
    @JsonCreator
    public static AbsoluteBoundingBoxType forValue(String value) throws IOException {
        ...
        throw new IOException("Cannot deserialize AbsoluteBoundingBoxType");
    }
}
