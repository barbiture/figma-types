 ...
 * The root node within the document
 */
export interface FileResponseDocument {
  /**
   * An array of canvases attached to the document
   */
  children: DocumentElement[];
...
export namespace Convert {
  ...
  export function projectFilesResponseToJson(
    value: ProjectFilesResponse
  ): string {
    return JSON.stringify(value, null, 2);
  }
  ...
  const typeMap: any = {
    ...
    Horizontal: ["CENTER", "LEFT", "LEFT_RIGHT", "RIGHT", "SCALE"],
    Vertical: ["BOTTOM", "CENTER", "SCALE", "TOP", "TOP_BOTTOM"],
    EffectType: [
      "BACKGROUND_BLUR",
      "DROP_SHADOW",
      "INNER_SHADOW",
    ...
    ConstraintType: ["HEIGHT", "SCALE", "WIDTH"],
    Format: ["JPG", "PNG", "SVG"],
    PaintType: [
      "EMOJI",
      "GRADIENT_ANGULAR",
